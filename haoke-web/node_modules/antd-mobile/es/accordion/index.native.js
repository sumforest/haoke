...
import AccordionStyles from './style/index.native';
...
var Accordion = function (_React$Component2) {
    ...
    function Accordion() {
        ...
        _this2.renderHeader = function (section, _, isActive) {
        ...
        _this2.renderContent = function (section) {
            var styles = _this2.props.styles;
    ...
    _createClass(Accordion, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(RNAccordion, { initiallyActiveSection: defaultActiveSection, activeSection: activeSection, underlayColor: 'transparent', sections: headers, renderHeader: this.renderHeader, renderContent: this.renderContent, duration: 0, onChange: this.onChange })
            );
        }
    }]);
