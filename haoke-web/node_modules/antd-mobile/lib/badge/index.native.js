...
var Badge = function (_React$Component) {
    ...
    (0, _createClass3['default'])(Badge, [{
        ...
        value: function render() {
            ...
            // fake styles
            var fakeStyles = styles;
            var badgeCls = corner ? 'textCorner' : 'textDom';
            var contentDom = !dot ? _react2['default'].createElement(
                _reactNative.View,
                (0, _extends3['default'])({}, restProps, { style: [styles[badgeCls], fakeStyles['' + badgeCls + size]] }),
                _react2['default'].createElement(
                    _reactNative.Text,
                    { style: [styles.text] },
                    text
                )
            ) : _react2['default'].createElement(_reactNative.View, (0, _extends3['default'])({}, restProps, { style: [styles.dot, fakeStyles['dotSize' + size]] }));
