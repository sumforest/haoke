...
exports['default'] = {
    showActionSheetWithOptions: function showActionSheetWithOptions(config, callback) {
        if (_reactNative.Platform.OS === 'ios') {
            ...
            _rnTopview2['default'].set(_react2['default'].createElement(_AndroidContainer2['default'], { visible: true, ref: function ref(_ref) {
                    return instance = _ref;
                }, onAnimationEnd: onAnimationEnd, config: config, callback: callback }));
        }
    },
