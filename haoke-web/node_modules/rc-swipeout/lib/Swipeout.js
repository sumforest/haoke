    ...
    (0, _createClass3['default'])(Swipeout, [{
        ...
        value: function render() {
            ...
            return (left.length || right.length) && !disabled ? _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    _rcGesture2['default'],
                    (0, _extends3['default'])({ onPanStart: this.onPanStart, onPanMove: this.onPanMove, onPanEnd: this.onPanEnd, onPanCancel: this.onPanEnd, onSwipeLeft: this.doOpenRight, onSwipeRight: this.doOpenLeft, direction: 'horizontal' }, refProps),
                    _react2['default'].createElement(
                        'div',
