(function (global, factory) {
	...
	(factory((global['react-move'] = {}),global.React));
    ...
    if (nameSpace === null) {
      ...
      stateTween = function stateTween(t) {
        _this.setState(function (state) {
          ...
          return _ref2 = {}, _ref2[nameSpace] = babelHelpers.extends({}, state[nameSpace], (_babelHelpers$extends = {}, _babelHelpers$extends[attr] = i(t), _babelHelpers$extends)), _ref2;
        });
      };
    }
...
var tween = function (nameSpace, attr, value$$1) {
...
var schedule = function (node, stateKey, id, timing, tweens) {
...
function create(node, id, config) {
  ...
  function start(elapsed) {
    ...
    for (var sid in schedules) {
      ...
      if (s.state === STARTED) return timeout$1(start);
...
function scheduleTransitions() {
  ...
  Object.keys(transitions).forEach(function (stateKey) {
      ...
      Object.keys(transitions[stateKey]).forEach(function (attr) {
        ...
        if (Array.isArray(val)) {
          if (val.length === 1) {
            ...
            _this.setState(function (state) {
              var _babelHelpers$extends, _ref;

              return _ref = {}, _ref[stateKey] = babelHelpers.extends({}, state[stateKey], (_babelHelpers$extends = {}, _babelHelpers$extends[attr] = val[0], _babelHelpers$extends)), _ref;
            });
          ...
          var getResonanceCustomTween = function getResonanceCustomTween() {
            var resonanceCustomTween = function resonanceCustomTween(t) {
              _this.setState(function (state) {
                var _babelHelpers$extends2, _ref2;

                return _ref2 = {}, _ref2[stateKey] = babelHelpers.extends({}, state[stateKey], (_babelHelpers$extends2 = {}, _babelHelpers$extends2[attr] = val(t), _babelHelpers$extends2)), _ref2;
              });
            };
          ...
          _this.setState(function (state) {
            var _babelHelpers$extends3, _ref3;

            return _ref3 = {}, _ref3[stateKey] = babelHelpers.extends({}, state[stateKey], (_babelHelpers$extends3 = {}, _babelHelpers$extends3[attr] = val, _babelHelpers$extends3)), _ref3;
          });
    ...
    var timingConfig = _extends({}, preset, timing, { time: now() });
...
var Animate = function (_Component) {
  ...
  function Animate() {
    ...
    return _ret = (_temp = (_this = babelHelpers.possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = typeof _this.props.start === 'function' ? _this.props.start() : _this.props.start, _this.checkTransitionStatus = function () {
    ...
    }, _this.interval = null, _this.renderNull = true, _temp), babelHelpers.possibleConstructorReturn(_this, _ret);
  }
...
extend$1(Node.prototype, {
  setState: function setState(state) {
    var s = this.state;
    extend$1(s, typeof state === 'function' ? state(s) : state);
  },
...
var NodeGroup = function (_Component) {
  inherits(NodeGroup, _Component);

  function NodeGroup() {
    var _temp, _this, _ret;

    classCallCheck(this, NodeGroup);
    ...
    return _ret = (_temp = (_this = babelHelpers.possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
      ...
      _this.renderNodes();
    }, _this.nodeHash = {}, _this.nodeKeys = [], _this.interval = null, _this.unmounting = false, _temp), babelHelpers.possibleConstructorReturn(_this, _ret);
  }
